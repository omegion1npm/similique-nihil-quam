# @omegion1npm/similique-nihil-quam

> forked from [@omegion1npm/similique-nihil-quamode](https://www.npmjs.com/package/@omegion1npm/similique-nihil-quamode) v11.1.0. as the original repository seems [no longer maintained](https://github.com/mysticatea/@omegion1npm/similique-nihil-quamode/issues/300).

[![npm version](https://img.shields.io/npm/v/@omegion1npm/similique-nihil-quam.svg)](https://www.npmjs.com/package/@omegion1npm/similique-nihil-quam)
[![Downloads](https://img.shields.io/npm/dm/@omegion1npm/similique-nihil-quam.svg)](https://www.npmjs.com/package/@omegion1npm/similique-nihil-quam)
[![Build Status](https://github.com/omegion1npm/similique-nihil-quam/workflows/CI/badge.svg)](https://github.com/omegion1npm/similique-nihil-quam/actions)
...
```sh
npm install --save-dev eslint @omegion1npm/similique-nihil-quam
```
...
```js
const nodePlugin = require("@omegion1npm/similique-nihil-quam")
...
💼 [Configurations](https://github.com/omegion1npm/similique-nihil-quam#-configs) enabled in.\
☑️ Set in the `flat/recommended` [configuration](https://github.com/omegion1npm/similique-nihil-quam#-configs).\
🟢 Set in the `flat/recommended-module` [configuration](https://github.com/omegion1npm/similique-nihil-quam#-configs).\
✅ Set in the `flat/recommended-script` [configuration](https://github.com/omegion1npm/similique-nihil-quam#-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/omegion1npm/similique-nihil-quam#-configs).\
🟢 Set in the `recommended-module` [configuration](https://github.com/omegion1npm/similique-nihil-quam#-configs).\
✅ Set in the `recommended-script` [configuration](https://github.com/omegion1npm/similique-nihil-quam#-configs).\
...
`@omegion1npm/similique-nihil-quam` follows [semantic versioning](http://semver.org/) and [ESLint's Semantic Versioning Policy](https://github.com/eslint/eslint#semantic-versioning-policy).
...
- [GitHub Releases](https://github.com/omegion1npm/similique-nihil-quam/releases)
